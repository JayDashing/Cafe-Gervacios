                ...
                <div class="rounded-xl border border-slate-200/90 bg-white p-4 shadow-sm sm:p-5">
                    ...
                    <form wire:submit.prevent="register" class="space-y-3">
                        ...
                        <div class="rounded-lg border border-slate-200 bg-slate-50 px-3 py-2">
                            ...
                            @else
                                <p class="mt-1 text-xs text-slate-500">No table selected. Add to queue still works.</p>
                            @endif
                        </div>
                        ...
                        <button type="button" wire:click="seatSelectedTable"
                            class="flex min-h-[42px] w-full items-center justify-center gap-2 rounded-lg border border-emerald-200 bg-emerald-50 py-2 text-sm font-semibold text-emerald-900 transition-colors hover:bg-emerald-100">
                            <i class="fa-solid fa-chair text-xs" aria-hidden="true"></i>
                            Seat selected table
                        </button>
                    </form>
                </div>
