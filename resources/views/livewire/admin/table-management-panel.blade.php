                        ...
                        <div class="mt-3 flex items-center gap-2">
                            @if ($status === 'available')
                                <a href="{{ route('admin.bookings') }}"
                                    class="tc-admin-btn-primary inline-flex min-h-9 flex-1 items-center justify-center px-3 py-2 text-xs">
                                    Assign Booking
                                </a>
                            ...
                            <div class="relative">
                                ...
                                <div x-cloak x-show="open" x-transition x-on:click.outside="open = false"
                                    ...
                                    role="menu">
                                    @if ($status === 'available')
                                        <button type="button" wire:click="markReserved({{ $table->id }})" x-on:click="open = false"
                                    ...
                                    @elseif ($status === 'reserved')
                                        ...
                                        <button type="button" wire:click="markFree({{ $table->id }})" x-on:click="open = false"
                                            class="block w-full px-3 py-2 text-left text-xs font-semibold text-slate-700 hover:bg-slate-50">
                                            Mark Free
                                        </button>
                                    @elseif ($status === 'occupied')
