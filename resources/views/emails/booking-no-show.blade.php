...
<head>
    ...
    <title>Reservation marked no-show</title>
</head>
                ...
                <table role="presentation" width="100%" cellspacing="0" cellpadding="0" style="max-width:520px;background-color:#ffffff;border:1px solid #e5e7eb;border-radius:8px;overflow:hidden;">
                    <tr>
                        <td style="padding:26px 28px 8px 28px;">
                            ...
                            <h1 style="margin:10px 0 0 0;font-size:22px;font-weight:700;color:#0f172a;line-height:1.3;">Reservation marked no-show</h1>
                        </td>
                    </tr>
                    <tr>
                        <td style="padding:8px 28px 24px 28px;">
                            ...
                            <p style="margin:0 0 18px 0;font-size:15px;line-height:1.6;color:#334155;">
                                Your reservation was marked as no-show because it was not checked in within the allowed time.
                            </p>
                            <table role="presentation" width="100%" cellspacing="0" cellpadding="0" style="border:1px solid #e2e8f0;border-radius:6px;background-color:#f8fafc;">
                                <tr>
                                    <td style="padding:16px 18px;">
                                        <p style="margin:0 0 6px 0;font-size:12px;text-transform:uppercase;letter-spacing:0.06em;color:#64748b;">Booking reference</p>
                                        <p style="margin:0;font-size:20px;font-weight:700;letter-spacing:0.05em;color:#0f172a;font-family:ui-monospace,Menlo,Monaco,Consolas,monospace;">{{ $bookingRef }}</p>
                                    </td>
                                </tr>
                            </table>
                            <p style="margin:18px 0 0 0;font-size:13px;line-height:1.6;color:#64748b;">
                                Please contact staff if this was marked by mistake.
                            </p>
                        </td>
                    </tr>
                    <tr>
                        <td style="padding:0 28px 26px 28px;">
                            <p style="margin:0;font-size:12px;color:#94a3b8;">This message was sent because the reservation check-in window has passed.</p>
                        </td>
                    </tr>
                </table>
            </td>
